...
// // SINGLE SIGN-ON - CONFIGURAÇÃO CORRIGIDA
// const AZURE_CLIENT_ID = process.env.AZURE_CLIENT_ID;
// const AZURE_CLIENT_SECRET = process.env.AZURE_CLIENT_SECRET;
// const AZURE_TENANT_ID = process.env.AZURE_TENANT_ID;
// // ⚠️ CORREÇÃO: Alterar para apontar para a rota de callback correta
// const REDIRECT_URI='http://localhost:5000/office365/callback'
...
// // Rota para receber o callback do Azure após login
...
// //   try {
// //     console.log('Tentando obter token com o código recebido...');
...
// //     const [rows] = await pool.promise().query('SELECT * FROM view_usuarios WHERE email = ?', [emailLogado]);

// //     if (rows.length > 0) {
// //       const user = rows[0];
// //       console.log('Usuário encontrado no banco:', user.email);
      
// //       // Gera o JWT token igual ao login normal
...
// //       console.log('Redirecionando para o frontend com dados do usuário');
// //       // Redireciona para o frontend com os dados do usuário
// //       res.redirect(`http://localhost:5173/intranet/sso-callback?user=${userData}`);
// //     } else {
// //       console.log('Usuário não encontrado no banco de dados');
// //       res.redirect('http://localhost:5173/intranet/sso-callback?error=user_not_found');
// //     }
// //   } catch (error) {
// //     console.error('Erro no redirect:', error);
// //     res.redirect('http://localhost:5173/intranet/sso-callback?error=login_failed');
// //   }
// // });

// // 🔧 NOVA ROTA: Callback específico para SSO
// router.get('/callback', async (req, res) => {
//   console.log('SSO Callback recebido com parâmetros:', req.query);
  
//   // Verifica se há código de autorização
//   if (!req.query.code) {
//     console.error('Código de autorização não encontrado');
//     return res.redirect('http://localhost:5173/intranet/sso-callback?error=authorization_code_missing');
//   }
...
//       // Prepara dados do usuário para enviar ao frontend
//       const userData = {
//         id: user.id,
//         name: user.name,
//         email: user.email,
...
//       // 🎯 Redireciona para a rota específica do SSO callback no frontend
